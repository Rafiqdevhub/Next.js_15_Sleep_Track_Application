    ...
    <div className="font-sans bg-gray-100 text-gray-800">
      ...
      <section className="py-16 px-8 bg-white">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto text-center">
          At SleepWise, we aim to help individuals achieve better sleep and
      ...
      <section className="py-16 px-8 bg-white">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto text-center">
          SleepWise was created to address the growing need for better sleep
      ...
      <section className="py-16 px-8 bg-gray-100 text-center">
        ...
        <p className="text-lg mb-6 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 bg-clip-text text-transparent">
          Join SleepWise today and take the first step towards better sleep and
          a healthier life.
        </p>
        <Link
          href="/sign-up"
